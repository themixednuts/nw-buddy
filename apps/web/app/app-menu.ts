...
export const APP_MENU: AppMenuGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Armor Sets", path: "/armor-sets", svgIcon: svgShield },
      {
        label: "Armor Weights",
        path: "/armor-weights",
        svgIcon: svgWeightHanging,
      },
      {
        label: "Transmog",
        path: "/transmog",
        icon: "assets/icons/menu/transmogtoken.webp",
      },
      ...
      { label: "Emotes", path: "/emotes", svgIcon: svgMasksTheater },
      {
        label: "Season Pass",
        path: "/season-pass",
        icon: "assets/icons/menu/season.png",
      },
      {
        label: "Backstories - PTR Testing",
        path: "/backstories",
        icon: "assets/icons/menu/backstories.png",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Music Sheets",
        path: "/tracking/music-sheets",
        svgIcon: svgMusic,
      },
      { label: "Runes", path: "/tracking/runes", svgIcon: svgRune },
      {
        label: "Schematics",
        path: "/tracking/schematics",
        svgIcon: svgRulerCombined,
      },
...
//   [
//     Object.freeze({ label: "Logout", action: supabase.auth.signOut() }),
//   ],
// );
